...
public class Leds {
	...
	public static void main(String[] args) {
		...
		JLabel labelMod = new JLabel("бзбедх ярнимняр гю лндскмю цпсою");
		JLabel labelPrg = new JLabel("бзбедх ярнимняр гю опнцпюлю");
